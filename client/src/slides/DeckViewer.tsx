...
// Renders the current slide (an image when present, otherwise a styled placeholder) plus manual
// nav controls. Gestures drive the same next/prev handlers from App.
